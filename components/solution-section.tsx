...
export function SolutionSection() {
  ...
  return (
    ...
    >
      ...
      {/* 🔹 Semi-transparent Plate (in front of bg, behind text) */}
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="w-[90%] md:w-[85%] lg:w-[75%] bg-blue-600/60 backdrop-blur-md rounded-3xl shadow-lg border border-white/20 h-[70%]" />
      </div>
      ...
      <div className="relative max-w-7xl mx-auto text-center z-10">
        ...
        <motion.div
          className="grid md:grid-cols-3 gap-8 z-10 relative"
          variants={containerVariants}
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true }}
        >
          {features.map((feature, index) => {
            ...
            return (
              <motion.div
                key={index}
                className="p-8 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl text-center text-white shadow-md hover:bg-white/20 transition"
                variants={itemVariants}
              >
