...
export function DifferentiatorsSection() {
  ...
  return (
    <section id="differentiators" className="py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <motion.div
            className="bg-gradient-to-br from-primary/10 to-transparent border border-primary/20 rounded-lg p-8"
