...
export const metadata = {
  title: "AI SEO, GEO & AEO Services — Get Found on Google & ChatGPT | QoraxAI",
  description:
    "Rank on Google, ChatGPT, Gemini & voice search. QoraxAI's AI SEO, Generative Engine Optimization (GEO) & Answer Engine Optimization (AEO) services build lasting search visibility.",
  alternates: {
    canonical: `${SITE_URL}/services/ai-seo-geo-aeo`,
  },
  robots: { index: true, follow: true },
  openGraph: {
    type: "website",
    url: `${SITE_URL}/services/ai-seo-geo-aeo`,
    title: "AI SEO, GEO & AEO Services — Get Found on Google & ChatGPT | QoraxAI",
    description:
      "Rank on Google, ChatGPT, Gemini & voice search. QoraxAI's AI SEO, GEO & AEO services build lasting search visibility worldwide.",
    siteName: "QoraxAI",
    images: [OG_IMAGE],
  },
  twitter: {
    ...
    title: "AI SEO, GEO & AEO Services — Get Found on Google & ChatGPT | QoraxAI",
    description:
      "Rank on Google, ChatGPT, Gemini & voice search with QoraxAI's AI SEO, GEO & AEO services.",
    images: [OG_IMAGE.url],
  },
}
...
const jsonLd = {
  ...
  description:
    "AI-first search optimisation including traditional SEO, Generative Engine Optimisation (GEO), and Answer Engine Optimisation (AEO) for Google, ChatGPT, Gemini, and voice search.",
  provider: {
    "@type": "LocalBusiness",
    name: "QoraxAI",
    url: SITE_URL,
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
        ...
        <div className="max-w-6xl mx-auto mt-20 mb-20">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 text-left">
            {[
              { title: "Built for AI Search", body: "We optimise for Google and for ChatGPT, Gemini, Perplexity, and every AI platform your customers are already using." },
              { title: "100% White Hat", body: "Every backlink, citation, and piece of content we produce is earned manually through genuine outreach. No shortcuts that put your site at risk." },
              { title: "Strategy, Not Tasks", body: "We build systems, not checklists. Everything we do connects back to growing your visibility, authority, and revenue over time." },
              { title: "Transparent Reporting", body: "You always know what we're doing and why. Monthly reports with real data, clear explanations, and the next steps mapped out." },
            ].map((card) => (
