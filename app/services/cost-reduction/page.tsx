    ...
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-50 to-white">
      ...
      <div className="max-w-5xl mx-auto mb-20 text-center">
        ...
        <p className="text-lg text-muted-foreground mb-12 leading-relaxed">
          ...
          over-provisioned cloud resources, inefficient hosting, and redundant tools silently drain your budget — often
          by 30-50% more than necessary.
        </p>
          ...
          <div className="grid md:grid-cols-2 gap-10">
            <div>
              ...
              <p className="text-muted-foreground mb-6">
                We analyze every dollar you spend on technology — software licenses, cloud services, hosting, hardware,
                and support contracts — to identify waste and savings opportunities.
              </p>
              ...
              <p className="text-muted-foreground">
                Identifying unused or underutilized licenses, consolidating duplicate tools, and renegotiating contracts
                to reduce annual software spend by 20-35%.
              </p>
            </div>
