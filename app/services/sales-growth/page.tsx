        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-10">
            ...
            <div>
              ...
              <p className="text-muted-foreground mb-6">
                Real-time dashboards show exactly how your business is performing — revenue, conversion rates, customer
              ...
              <p className="text-muted-foreground">
                We continuously test headlines, CTAs, images, and pricing to find what resonates best with your audience
      ...
      <div className="bg-white py-16">
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <p className="text-lg text-muted-foreground mb-10 leading-relaxed">
            Whether you're a startup looking to scale, an SME aiming for predictable growth, or an enterprise seeking to
            optimize underperforming channels — this service is for you.
          </p>
          ...
          <div className="grid sm:grid-cols-3 gap-6 text-left">
            ...
            <div className="p-6 bg-gray-50 rounded-2xl">
              ...
              <p className="text-muted-foreground">Generate more leads, shorten sales cycles, and close more deals.</p>
            </div>
          </div>
        </div>
      </div>
